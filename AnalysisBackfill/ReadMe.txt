...
Example syntax: AnalysisBackfill.exe \\AF1\TestDB\Plant1\Pump1 FlowRate_*Avg '*-10d' '*' recalc AnalysisBackfill.exe \\AF1\TestDB\Plant1 *Rollup '*-10d' '*' backfill

For element paths that have spaces, use quotation marks (") around the path.
